...
#define NODE_MAIN_LOGGER_NAME "map_loader"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmap_loader_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ee4308::turtle2::MapLoader>";
