...
#define NODE_MAIN_LOGGER_NAME "behavior"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbehavior_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ee4308::turtle2::Behavior>";
