...
#define NODE_MAIN_LOGGER_NAME "planner"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libplanner_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ee4308::turtle2::Planner>";
