...
#define NODE_MAIN_LOGGER_NAME "estimator"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libestimator_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ee4308::drone::Estimator>";
